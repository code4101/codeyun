...
def test_solver_uses_yin_as_negative_vector_and_ranks_by_value_ratio() -> None:
    ...
    result = solve_alchemy(recipe, herbs, width=2, height=1, limit=5)
    ...
    first_page = solve_alchemy(recipe, herbs, width=2, height=1, limit=1)
...
def test_solver_applies_bottom_element_yield_rule() -> None:
    ...
    result = solve_alchemy(recipe, herbs, width=2, height=2, limit=1)
