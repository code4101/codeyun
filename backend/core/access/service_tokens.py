...
SERVICE_SCOPE_VISION_ANALYZE = "services.vision:analyze"
...
DEFAULT_VISION_SERVICE_SCOPES = (SERVICE_SCOPE_VISION_ANALYZE, SERVICE_SCOPE_OCR_PREDICT, SERVICE_SCOPE_OCR_STATUS)
