...
def default_data_annotation_scheduler_tasks() -> list[dict[str, Any]]:
    ...
    return [
        ...
        runtime_daily_task("daily-boss", "daily_boss", "日常_首领", "05:00", cooldown_seconds=600),
        ...
        runtime_daily_task("legacy-daily-youli", "daily_youli", "日常_游历", "00:00", "05:00", cooldown_seconds=600),
        runtime_daily_task("legacy-daily-assistant", "daily_assistant", "日常_助手", "00:00", "06:00", "12:00", "18:00", enabled=False, cooldown_seconds=600),
        ...
        runtime_daily_task("legacy-daily-lingta", "daily_lingta", "日常_灵塔", "05:00", cooldown_seconds=600),
        runtime_daily_task("legacy-daily-shuangxiu", "daily_shuangxiu", "日常_双修", "05:00", cooldown_seconds=600),
        runtime_daily_task("legacy-daily-xianyuan", "daily_xianyuan", "日常_挑战仙缘", "05:00", cooldown_seconds=600),
        runtime_daily_task("legacy-daily-lingzu", "daily_lingzu", "日常_灵祖", "05:00", cooldown_seconds=600),
        runtime_daily_task("legacy-daily-jianling", "daily_jianling", "日常_剑灵", "05:00", cooldown_seconds=600),
        runtime_daily_task("legacy-daily-yaowang", "daily_yaowang", "日常_妖王来袭", "05:00", cooldown_seconds=600),
        runtime_daily_task("legacy-daily-yaozu", "daily_yaozu", "日常_妖族袭城", "05:00", cooldown_seconds=600),
