...
def default_data_annotation_scheduler_tasks() -> list[dict[str, Any]]:
    ...
    return [
        ...
        runtime_daily_task("legacy-daily-dongtian-clear", "daily_dongtian_clear", "洞天_行动力", "21:30", window=("10:00", "22:00"), cooldown_seconds=300),
        runtime_daily_task("legacy-daily-lingmai-clear", "daily_lingmai_clear", "灵脉_清体力", "21:30", window=("10:00", "22:00"), cooldown_seconds=300),
        runtime_daily_task("legacy-daily-mojie-raid", "daily_mojie_raid", "日常_奇袭魔界", "13:00", "21:30", cooldown_seconds=600),
