...
def default_data_annotation_scheduler_tasks() -> list[dict[str, Any]]:
    ...
    return [
        ...
        runtime_daily_task("legacy-daily-dongtian", "daily_dongtian", "日常_洞天福地", "14:00", window=("10:00", "22:00"), cooldown_seconds=600),
        runtime_daily_task("legacy-daily-dongtian-clear", "daily_dongtian_clear", "日常_洞天福地_清行动力", "21:30", window=("10:00", "22:00"), cooldown_seconds=600),
        runtime_daily_task("legacy-daily-lingmai-clear", "daily_lingmai_clear", "日常_灵脉_清体力", "21:30", window=("10:00", "22:00"), cooldown_seconds=600),
