...
class FanxiuMailPacketSyncResponse(BaseModel):
    ok: bool = True
    cleared: int = 0
    inserted: int = 0
    updated: int = 0
    action_updated: int = 0
    record_count: int = 0
    source_count: int = 0
    source_packets: int = 0
    action_packets: int = 0
    skipped_mail_vo: int = 0
    unknown_mail_protocol_packets: int = 0
    unparsed_mail_protocol_packets: int = 0
    unknown_mail_protocol_samples: list[dict[str, Any]] = Field(default_factory=list)
