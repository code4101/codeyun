...
class ZaohuaAlchemyRecipe(SQLModel, table=True):
    ...
    output_description: str = Field(default="", sa_column=Column(Text))
    output_effect_description: str = Field(default="", sa_column=Column(Text))
...
class ZaohuaHerb(SQLModel, table=True):
    ...
    crafting_attributes: list[dict] = Field(default_factory=list, sa_column=Column(JSON))
