...
const FANXIU_PROTOCOL_SEMANTICS_PATH = requirePageMenuPath('FanxiuProtocolSemantics');
...
const FANXIU_PROTOCOL_SEMANTICS_TITLE = requirePermissionTitleByMenuPath(FANXIU_PROTOCOL_SEMANTICS_PATH);
...
const fanxiuMenuVisible = computed(() =>
  ...
  && [
    ...
    FANXIU_WIKI_PATH,
    FANXIU_PROTOCOL_SEMANTICS_PATH,
        ...
        >
          ...
          <el-sub-menu v-if="gameToolsMenuVisible" index="game-tools">
            ...
            <el-sub-menu v-if="fanxiuMenuVisible" index="fanxiu">
              ...
              <el-menu-item v-if="canAccessMenuPath(FANXIU_PROTOCOL_SEMANTICS_PATH)" :index="FANXIU_PROTOCOL_SEMANTICS_PATH">{{ FANXIU_PROTOCOL_SEMANTICS_TITLE }}</el-menu-item>
